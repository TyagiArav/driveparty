# Make your own DriveParty

Everything you need to run your own copy of DriveParty: Google Cloud setup, running it locally, deploying to Render, and how it works under the hood. For what DriveParty is, see the [README](README.md).
